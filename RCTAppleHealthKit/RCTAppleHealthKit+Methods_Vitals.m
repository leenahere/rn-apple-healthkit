...
{
    HKQuantityType *walkingHeartRateAverageType = [HKQuantityType quantityTypeForIdentifier:HKQuantityTypeIdentifierWalkingHeartRateAverage];
    ...
    [self fetchQuantitySamplesOfType:walkingHeartRateAverageType
                                unit:unit
                           predicate:predicate
                           ascending:ascending
                               limit:limit
